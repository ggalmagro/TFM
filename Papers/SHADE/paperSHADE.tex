...
\begin{table}[!h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{>{\centering\arraybackslash}c m{5cm} cc}
			...
			\hline
			$p_\text{size}$ & Population size & 100 & 100 \\
			Evals & Fitness function evaluations & 300000 & 300000 \\
			$p_e$ & Size of the elite set in population & $0.2 * p_\text{size}$ & $0.25 * p_\text{size}$ \\
			$p_m$ & Number of mutants to be introduced in the population in each generation & $0.2 * p_\text{size}$ & - \\
