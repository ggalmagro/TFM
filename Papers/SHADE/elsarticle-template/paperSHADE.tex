...
\begin{table}[!h]
	...
	\begin{tabular}{c c c c}
		\hline
		Name & Number of Instances & Number of Classes & Features \\
		\hline
		& & & \\
		& & & \\
		& & & \\
...
\begin{table}[!h]
	...
	\begin{tabular}{lcc c cc c cc c cc}
		\hline
		\multirow{2}{*}{Dataset} &
		\multicolumn{2}{c}{Percent 1\%} &&  \multicolumn{2}{c}{Percent 5\%} && \multicolumn{2}{c}{Percent 15\%} && \multicolumn{2}{c}{Percent 20\%} \\
