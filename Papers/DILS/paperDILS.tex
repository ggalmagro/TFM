...
\begin{table}[!h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{lccccccc}
			\hline
			Dataset & DILS$_{CC}$ & BRKGA & COPKM & LCVQE & RDPM & TVClust & CECM \\
			\hline
...
\begin{table}[!h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{lccccccc}
			...
			Circles & \textbf{1.000} & 0.935 & \textbf{1.000} & -0.003 & 0.629 & \textbf{1.000} & 0.138 \\
			...
			Heart & \textbf{1.000} & 0.942 & \textbf{1.000} & 0.025 & 0.033 & \textbf{1.000} & 0.000 \\
			...
			Moons & \textbf{1.000} & 0.937 & \textbf{1.000} & 0.241 & 0.831 & \textbf{1.000} & 0.180 \\
