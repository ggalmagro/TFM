...
class LSSHADE:
    ...
    def __init__(self, data, ml_const, cl_const, population_size, nb_clust):
    ...
    def local_search(self):
        ...
        for clust in range(top):
            ...
            if current_fitness < self._population_fitness[clust]:

                self._population[clust, :] = current_clustering / self._result_nb_clust
                self._population_fitness[clust] = current_fitness
